...
/**
 * BubbleNotificationHelper — creates Android 11+ bubble notifications
...
object BubbleNotificationHelper {
     ...
     * @param title Notification title (e.g. "AI Daddy 💙")
    ...
    fun showBubble(
        ...
        try {
            ...
            // Ultimate fallback — basic notification via NotificationManager
